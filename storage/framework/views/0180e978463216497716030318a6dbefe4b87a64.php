...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-primary btn-sm" href="<?php echo e(route('news-detail', [$detail->cate->slug, $detail->slug, $detail->id ])); ?>" target="_blank" style="margin-top:-6px"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>
    <div class="block-author edit">
      <ul>
        ...
        <li>
            <span>Ngày tạo:</span>
          <span class="name"><?php echo date('d/m/Y H:i', strtotime($detail->created_at)); ?></span>
          
        </li>
         <li>
            <span>Cập nhật lần cuối:</span>
          <span class="name"><?php echo $detail->updatedUser->display_name; ?> ( <?php echo date('d/m/Y H:i', strtotime($detail->updated_at)); ?> )</span>          
        </li>        
      </ul>
    </div>
    <form role="form" method="POST" action="<?php echo e(route('articles.update')); ?>" id="dataForm">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_image_url" src="<?php echo e($detail->image_url ? Helper::showImage($detail->image_url ) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-thumbnail" width="145" height="85">
