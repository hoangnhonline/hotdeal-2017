          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td>                  
                  <?php echo e($item->code); ?> - <a style="color:#333;font-weight:bold" href="<?php echo e(route( 'product.edit', [ 'id' => $item->id ])); ?>"><?php echo e($item->name); ?></a> &nbsp; <?php if( $item->is_hot == 1 ): ?>
                ...
                <td style="text-align:right"><?php echo e(number_format($item->inventory)); ?></td>
                <td style="white-space:nowrap; text-align:right">
                  <a class="btn btn-default btn-sm" href="<?php echo e(route('product', [$item->slug] )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>                  
