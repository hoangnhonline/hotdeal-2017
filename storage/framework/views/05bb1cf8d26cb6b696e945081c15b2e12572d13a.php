	...
	<div class="block-header">
		<div class="container">
			<div class="row">
				...
				<ul class="hdr-social">
					<li><a href="<?php echo e($settingArr['facebook_fanpage']); ?>" target="_blank"><i class="fa fa-facebook"></i></a></li>
					<li><a href="<?php echo e($settingArr['google_fanpage']); ?>" target="_blank"><i class="fa fa-google"></i></a></li>
					<li><a href="<?php echo e($settingArr['youtube']); ?>" target="_blank"><i class="fa fa-youtube"></i></a></li>
					<li><a href="skype:<?php echo e($settingArr['skype']); ?>?chat"><i class="fa fa-skype"></i></a></li>-->
				</ul>
			</div>
		</div>
		...
		<div class="block-fb">
			...
			<div class="fb-inner">
				<div class="fb-page" data-href="<?php echo e($settingArr['facebook_fanpage']); ?>" data-tabs="timeline" data-width="300px" data-height="500px" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="<?php echo e($settingArr['facebook_fanpage']); ?>" class="fb-xfbml-parse-ignore"><a href="<?php echo e($settingArr['facebook_fanpage']); ?>">Facebook</a></blockquote></div>
			</div>
		</div>
		...
		<nav class="menu-top">
			<div class="container">
				<ul class="nav-menu">
					...
					<li class="level0 <?php if( $routeName == "contact"): ?> active <?php endif; ?>"><a href="<?php echo route('contact'); ?>" title="Liên Hệ">Liên Hệ</a></li>
					<li class="nav-info">
