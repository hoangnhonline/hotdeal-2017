        ...
        <div class="block-content">
          <form action="<?php echo e(route('payment')); ?>" method="POST" class="form-billing" id="paymentForm">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <div class="thumb">
                  <img src="<?php echo e(URL::asset('public/assets/images/payments/VIB.jpg')); ?>" alt="VIB">
                </div>
                <div class="des">
            ...
            <div class="form-group text-right">
              <a href="<?php echo route('address-info'); ?>" title="Quay Lại" id="btnBack" class="btn btn-default"><i class="fa fa-long-arrow-left"></i> Quay Lại</a>
